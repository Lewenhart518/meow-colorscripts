...
# ────────────────────────────────────────────────────────────── 
# Detectar idioma desde install.sh (default en "en")
LANGUAGE="en"
if [[ -f "$LANG_FILE" ]]; then
...
if [[ ! -d "$SCRIPT_PATH" ]]; then
    echo -e "${RED}Error: No se encontró la carpeta $SCRIPT_PATH.${NC}"
...
# ────────────────────────────────────────────────────────────── 
# Verificar si los comandos de nombres están activos
