#!/bin/bash
# ========================================================
# Instalación de meow-colorscripts (Versión MiauColor)
# ========================================================
# Este script instala meow-colorscripts con un toque felino:
# • Selecciona y guarda el idioma en ~/.config/meow-colorscripts/lang.
# • Clona el repositorio (si no existe) en ~/meow-colorscripts y
#   mueve la carpeta de configuración a ~/.config/meow-colorscripts.
# • Instala en ~/.local/bin los siguientes comandos con el prefijo:
...
# • Actualiza el PATH acorde a la shell del usuario.
# • Presenta mensajes vivos y coloridos, y al final pregunta si iniciar la configuración.
# ========================================================
...
# Función para mostrar mensajes felinos dinámicos con icono de validación
